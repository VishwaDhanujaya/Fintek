...
<footer class="bg-slate-900 text-gray-300 py-12 mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    <li class="flex items-start">
                        <svg class="h-5 w-5 text-fintek-blue-light mr-2 mt-0.5 flex-shrink-0" fill="none"
                    ...
                    <li class="flex items-center mt-3">
                        <svg class="h-5 w-5 text-fintek-blue-light mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div
            class="border-t border-slate-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
            ...
            <div class="flex space-x-4 mt-4 md:mt-0 items-center">
                ...
                <a href="https://www.facebook.com/finteksharp?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer"
