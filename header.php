...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex space-x-8">
                ...
                <a href="products.php" class="text-gray-600 hover:text-fintek-blue nav-link font-medium">Products</a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div id="searchContainer" class="hidden absolute top-20 right-4 sm:right-8 bg-white p-4 shadow-lg rounded-lg border border-gray-100">
                    <input type="text" placeholder="Search products..." class="border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-fintek-blue-light focus:border-transparent">
                </div>
    ...
    <div class="md:hidden hidden bg-white border-t border-gray-100" id="mobileMenu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 shadow-inner">
            ...
            <a href="about.php" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-fintek-blue hover:bg-gray-50 rounded-md">About Us</a>
            <a href="products.php" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-fintek-blue hover:bg-gray-50 rounded-md">Products</a>
            <a href="contact.php" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-fintek-blue hover:bg-gray-50 rounded-md">Contact Us</a>
        </div>
    </div>
</header>
