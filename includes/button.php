...
?>
<button type="<?= htmlspecialchars($buttonType) ?>" class="bg-fintek-blue hover:bg-fintek-blue-light text-white font-semibold py-2 px-6 rounded-lg transition-all duration-200 shadow-md <?= htmlspecialchars($buttonClass) ?>">
