                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    ...
                    <ul class="space-y-6">
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-10 h-10 bg-blue-50 text-fintek-blue rounded-lg flex items-center justify-center mr-4">
            ...
            <div class="w-full lg:w-1/2" data-aos="fade-left">
                <div class="bg-white rounded-2xl p-8 lg:p-10 shadow-sm border border-gray-100">
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        ...
                        <div class="relative">
                            <input type="email" id="email" name="email" class="block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-fintek-blue peer" placeholder=" " required />
                            <label for="email" class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-fintek-blue peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Email Address</label>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <label for="department" class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-fintek-blue">Department</label>
                        ...
                        <div class="relative">
                            ...
                            <label for="product_ref" class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-fintek-blue">Product Reference</label>
                        </div>
                        <?php endif; ?>
                        
                        <div class="relative">
                            <textarea id="message" name="message" rows="4" class="block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-fintek-blue peer" placeholder=" " required></textarea>
